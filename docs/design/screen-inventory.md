...
| 画面        | パス            | 状態定義                                                                                                                                                                                                                                                           |
| ----------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AI チャット | `/ai-assistant` | 通常: チャット UI（メッセージ履歴 + テキスト入力 + 送信ボタン）。空状態: Bot アイコン + 「何でも聞いてください」+ サジェスション 4 ボタン。送信中: アシスタントメッセージに Loader。ストリーミング: テキストがリアルタイムで表示。エラー: メッセージ内にエラー表示 |
